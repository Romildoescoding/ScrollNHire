          ...
          <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-0 border-l border-r dark:border-zinc-200 border-zinc-800">
            ...
            <div className="border-b border-r-0 md:border-r dark:border-zinc-200 border-zinc-800 p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-start items-start gap-4 sm:gap-6">
              ...
              <div className="w-full h-[200px] sm:h-[250px] md:h-[300px] rounded-lg flex items-center justify-center overflow-hidden">
                ...
                <div className="relative w-72 h-[600px] scale-[33%] sm:scale-[41%] md:scale-50 rounded-[45px] shadow-[0_0_2px_2px_rgba(255,255,255,0.1)] border-8 border-zinc-900">
                  ...
                  <div className="relative w-full h-full  rounded-[37px] overflow-hidden flex items-center justify-center bg-transparent">
                    <video
                      src="/videos/scroll-feed.mp4"
                      muted
                      autoPlay
                      loop
