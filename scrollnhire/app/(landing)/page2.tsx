...
const LandingPage = () => {
  ...
  return (
    <div className="h-full w-full">
      {/* HERO */}
      <div className="h-[30svh] relative text-3xl min-[510px]:text-5xl sm:text-6xl md:text-7xl sm:h-[30vh] bg-white dark:bg-black w-full flex flex-col items-center justify-end">
            ...
            <div className="flex gap-4">
              <div className="flex gap-2">
                ...
                {/* <div className="h-full aspect-square border bg-[blueviolet] rounded-xl">
                  <div className="h-full w-full flex items-center justify-center">
                    <div className="h-6 w-6 min-[510px]:h-8 min-[510px]:w-8 sm:h-12 sm:w-12 overflow-hidden relative">
                      ...
                      <Image
                        ...
                        width={60}
                        alt="gradient"
                        className="animate-scroll1 hidden absolute top-0 left-1/2 -translate-x-1/2 dark:block h-6 w-6 min-[510px]:h-8 min-[510px]:w-8 sm:h-12 sm:w-12"
                      />
                      <Image
                        src="/logo_black.svg"
                        height={60}
                        width={60}
                        alt="gradient"
                        className="animate-scroll2 absolute top-full left-1/2 -translate-x-1/2 hidden dark:block h-6 w-6 min-[510px]:h-8 min-[510px]:w-8 sm:h-12 sm:w-12"
                      />
                      ...
                      <Image
                        ...
                        width={60}
                        alt="gradient"
                        className="animate-scroll1 block absolute top-0 left-1/2 -translate-x-1/2 dark:hidden h-6 w-6 min-[510px]:h-8 min-[510px]:w-8 sm:h-12 sm:w-12"
                      />
                      <Image
                        src="/logo_white.svg"
                        height={60}
                        width={60}
                        alt="gradient"
                        className="animate-scroll2 absolute top-full left-1/2 -translate-x-1/2 block dark:hidden h-6 w-6 min-[510px]:h-8 min-[510px]:w-8 sm:h-12 sm:w-12"
                      />
                    </div>
                  </div>
                </div> */}
              ...
              <div className="flex gap-4">
                ...
                {/* <div className="h-full w-fit">
                  <Earth
                    size={innerWidth >= 640 ? 72 : innerWidth >= 510 ? 54 : 36}
                  />
                </div> */}
              </div>
            </div>
