...
const AppLayout = ({ children }: { children: ReactNode }) => {
  return (
    ...
    <div className="ml-2 w-full h-full flex justify-center relative rounded-t-lg">
      <Navbar />
      {/* <main className="max-w-[1440px] h-[calc(100vh-16px)] w-full pt-18 overflow-auto"> */}
      <main className="max-w-[1440px] h-screen md:h-[calc(100vh-16px)] w-full pt-14 md:pt-18 overflow-auto">
